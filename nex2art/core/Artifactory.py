...
class Artifactory:
    ...
    def migraterepos(self, conn, conf):
        ...
        for jsn in repo_json:
            self.add_repo_recursively(jsn, repo_json, repo_json_sorted, repos)
    ...
    def add_repo_recursively(self, jsn, repo_json, repo_json_sorted, repos, log_prefix='\t'):
    ...
    def dorequest(self, conndata, method, path, body=None):
        ...
        try:
            ...
            stat = ex.code
            self.log.debug(json.dumps(ex.read(), indent=2))
